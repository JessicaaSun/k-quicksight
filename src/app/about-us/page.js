  ...
  return (
    ...
    >
      ...
      <div className={"flex justify-center items-center"}>
        <p
          className={
            "text-description-color text-center mt-5 text-lg lg:w-1/2 md:w-2/3"
          }
        >
      ...
      <div className={"my-10 lg:px-[8%] md:px-5 px-3"}>
        <p
          className={
            "text-4xl capitalize text-primary-color font-bold text-center md:text-4xl max-sm:text-3xl sm:text-3xl md:mt-10 lg:my-10"
          }
        >
          Mission and vision
        </p>
        {data.map((e, index) => (
          ...
          >
            ...
            <div className={`${index === 1 ? "text-right" : " "} `}>
              ...
              <p
                className={
                  "mt-4 sm:text-lg text-description-color md:text-xl lg:text-xls"
                }
              >
                {e.description}
              </p>
      ...
      <div className={"md:px-[10%] max-sm:px-0 sm:px-0 "}>
        <p
          className={
            " text-primary-color md:text-4xl max-sm:text-3xl sm:text-3xl font-bold text-center my-10"
          }
        >
          Our mentors
        </p>
        <div className={"lg:flex w-full justify-center items-center"}>
          ...
          >
            <div className={"lg:w-1/3 sm:w-full md:w-2/3"}>
              ...
              />
              <h3 className={"text-center my-5 text-text-color"}>
                Ms. Mom Reksmey
              </h3>
            </div>
            <div className={"lg:w-1/3 sm:w-full md:w-2/3"}>
          ...
          <p
            className={
              "lg:w-1/2 sm:w-full md:w-2/3 text-lg text-description-color"
            }
          >
        ...
        <p
          className={
            "md:text-4xl max-sm:text-3xl sm:text-3xl text-primary-color font-bold text-center max-sm:mt-12 sm:mt-12 max-sm:mb-0 sm:mb-0 md:my-20"
          }
        >
          Our Members
        </p>
        <div className={"flex flex-wrap justify-around items-center"}>
          {members.map((e, index) => (
            <div key={index} className={"lg:w-1/4 md:w-1/3 m-10 "}>
              ...
              <h3
                className={
                  "text-text-color md:text-xl max-sm:text-lg sm:text-lg text-center capitalize"
                }
              >
                {e.name}
              </h3>
              <p
                className={
                  "text-primary-color font-semibold text-center text-lg mt-2"
                }
              >
                {e.position}
              </p>
