...
export default function AboutUs(){
    ...
    return (
        <section className={'py-32'}>
            ...
            <Image src={about} alt={'about'} className={'m-auto w-auto'} />
            <div className={'my-10 lg:px-[15%] md:px-[5%] px-5'}>
                ...
                {
                    data.map((e, index) => (
                        <div key={index} className={`lg:flex md:flex justify-center gap-5 items-center ${index === 1 ? "flex-row-reverse" : ""}`}>
                            ...
                            <div className={`${index === 1 ? "text-right" : ""}`}>
                                ...
                                <p className={'text-text-color'}>{e.description}</p>
                            </div>
                        </div>
                    ))
                }
            ...
            <div className={'px-[10%]'}>
                <p className={'text-4xl capitalize font-bold text-primary-color text-center my-16'}>Our mentors</p>
                <div className={'lg:flex md:flex w-full justify-center items-center'}>
                    <div className={'lg:flex md:flex justify-center items-center gap-10 mt-10'}>
                        <div className={'lg:w-1/3 md:w-2/3'}>
                            <Image src={Reksmey} alt={'instructor RakSmey'}  className={'rounded-2xl'}/>
                            <h3 className={'text-center my-5'}>Ms. Mom Reksmey</h3>
                        </div>
                        <div className={'lg:w-1/3 md:w-2/3'}>
                            <Image src={tara} alt={'instructor Tara'} className={'rounded-2xl'} />
                            <h3 className={'text-center my-5'}>Mr. Kit Tara</h3>
                        </div>
                    </div>
                    <p className={'lg:w-1/2 text-lg text-text-color'}>
                ...
                <div className={'flex flex-wrap justify-around items-center'}>
                    {
                        members.map((e, index) => (
                            <div key={index} className={'lg:w-1/4 md:w-1/3 m-10'}>
                                ...
                                <p className={'text-text-color text-center font-semibold capitalize text-3xl'}>{e.name}</p>
                                ...
                                <div className={'flex gap-[33px] justify-center items-center mt-5'}>
                                    <Tooltip showArrow={true} content={`${e.name} facebook`}>
                                        <Link href={e.facebook} className={'hover:scale-110 transition-all'}>
                                    ...
                                    <Tooltip showArrow={true} content={`${e.name} Instagram`}>
                                        <Link href={e.instagram} className={'hover:scale-110 transition-all'}>
                                    ...
                                    <Tooltip showArrow={true} content={`${e.name} GitHub`}>
                                        <Link href={e.github} className={'hover:scale-110 transition-all'}>
                                            <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
