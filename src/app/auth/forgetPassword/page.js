...
const ForgetPassword = () => {
  ...
  return (
    <div className={"md:py-36 max-sm:py-10 sm:py-10 flex justify-center items-center"}>
      {verify ? (
        <div
          className={
        ...
        <div
          id={"card"}
          className={"max-sm:pt-40 sm:pt-40 md:pt-10 lg:w-[40%] max-sm:px-8 sm:px-8 px-0 md:w-3/4 max-sm:w-full sm:w-full"}
        >
          <h2
