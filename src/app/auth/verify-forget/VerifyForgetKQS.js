...
export default function VerifyCodeKQS({ callback, reset, isLoading }) {
    ...
    <main className="flex min-h-screen flex-col items-center justify-between py-56">
      <div className={"grid md:grid-cols-2 place-items-center md:gap-16"}>
        <div className={"grid grid-cols-1 place-items-center px-3 md:px-0"}>
          <h1
            className={
              "text-primary-color text-center lg:text-[32px] dark:text-white"
            }
          >
          ...
          <Button
            radius="md"
            className={
              "w-full text-[18px] bg-primary-color dark:bg-third-color text-white"
            }
            onClick={dataCode}
          >
            Verify
