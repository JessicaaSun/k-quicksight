...
const AnalysisStep3 = ({headers}) => {
    ...
    return (
        <div className={"px-10"}>
           <p className={"text-2xl text-primary-color pt-10 font-bold"}>Simple Linear Regression</p>
            <div className={"py-9"}>
            ...
            <div>
                <p className={"text-xl text-primary-color pb-10 font-bold"}>Output Options</p>
