  ...
  file: {
    ...
    recent: {
      icon: (
        ...
        >
          <path
            d="M10.5833 0.5C5.08325 0.5 0.583252 5 0.583252 10.5C0.583252 16 5.08325 20.5 10.5833 20.5C16.0833 20.5 20.5833 16 20.5833 10.5C20.5833 5 16.0833 0.5 10.5833 0.5ZM14.7833 14.7L9.58325 11.5V5.5H11.0833V10.7L15.5833 13.4L14.7833 14.7Z"
            fill="#323232"
          />
        </svg>
      ),
      ...
      icon: (
        ...
        >
          <g clipPath="url(#clip0_1236_2535)">
            <path
              d="M10.5833 4.8335H4.58325C3.48325 4.8335 2.59325 5.7335 2.59325 6.8335L2.58325 18.8335C2.58325 19.9335 3.48325 20.8335 4.58325 20.8335H20.5833C21.6833 20.8335 22.5833 19.9335 22.5833 18.8335V8.8335C22.5833 7.7335 21.6833 6.8335 20.5833 6.8335H12.5833L10.5833 4.8335Z"
              fill="#323232"
            />
          </g>
          <defs>
            <clipPath id="clip0_1236_2535">
              <rect
                ...
                height="24"
                fill="white"
                transform="translate(0.583252 0.833496)"
              />
            </clipPath>
          </defs>
        </svg>
          ...
          <defs>
            <clipPath id="clip0_1236_2547">
              <rect
                ...
                height="24"
                fill="white"
                transform="translate(0.583252 0.5)"
              />
            </clipPath>
          </defs>
        </svg>
  ...
  visualization: {
    ...
    analysis: {
      icon: (
        ...
        >
          <path
            d="M18.361 0.5H2.80547C1.58325 0.5 0.583252 1.5 0.583252 2.72222V18.2778C0.583252 19.5 1.58325 20.5 2.80547 20.5H18.361C19.5833 20.5 20.5833 19.5 20.5833 18.2778V2.72222C20.5833 1.5 19.5833 0.5 18.361 0.5ZM7.24992 16.0556H5.0277V8.27778H7.24992V16.0556ZM11.6944 16.0556H9.47214V4.94444H11.6944V16.0556ZM16.1388 16.0556H13.9166V11.6111H16.1388V16.0556Z"
            fill="#323232"
          />
        </svg>
      ),
      ...
      icon: (
        ...
        >
          <g clipPath="url(#clip0_1236_2571)">
            <path
              d="M10 10.52H15V21.5H10V10.52ZM17 21.5H20C21.1 21.5 22 20.6 22 19.5V10.5H17V21.5ZM20 3.5H5C3.9 3.5 3 4.4 3 5.5V8.5H22V5.5C22 4.4 21.1 3.5 20 3.5ZM3 19.5C3 20.6 3.9 21.5 5 21.5H8V10.5H3V19.5Z"
              fill="#323232"
            />
          </g>
          <defs>
...
const BoardSidebar = ({ toggleSidebar }) => {
  ...
  return (
    <div
      ...
      } bg-white transition-all text-description-color z-20 left-0 px-5 pb-10 pt-5 fixed flex flex-col gap-10 top-[64px] lg:overflow-y-hidden md:overflow-y-scroll min-w-[278px] min-h-screen`}
    >
      ...
      <div className={"flex flex-col gap-5"}>
        <p className={"text-xl font-semibold text-primary-color text-bold"}>
          {contentRoute.file._name}
        </p>
        <div className={"flex flex-col gap-2"}>
          <Link
            className={` text-text-color text-xl pl-5 py-2 hover:bg-primary-color ${
      ...
      <div className={"flex flex-col gap-5"}>
        ...
        <div className={"flex flex-col gap-2"}>
          <Link
            ...
            } text-text-color text-xl pl-5 py-2 hover:bg-primary-color hover:text-white transition-all rounded-xl flex justify-start items-center gap-5`}
