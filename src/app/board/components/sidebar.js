...
const Sidebar = ({toggleSidebar}) => {
    ...
    return (
        <div className={`${toggleSidebar ? 'ml-[-1000px]' : ''} bg-white transition-all text-description-color z-20 left-0 px-5 py-10 fixed flex flex-col gap-20 top-[87px] min-w-[288px] min-h-screen`}>
