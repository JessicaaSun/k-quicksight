    ...
    <>
      {!isFull ? (
        <Button
          onPress={onOpen}
          className={
            "bg-primary-color text-sm text-white font-semibold border-2 border-white shadow-lg"
          }
        >
          New Dataset
        </Button>
              ...
              <div className={"flex p-5 flex-col gap-5"}>
                ...
                <ModalBody className={"flex flex-row gap-5 w-full"}>
                  ...
                  <label
                    htmlFor="importFile"
                    className={
                      "text-white rounded-xl flex justify-center items-center hover:bg-secondary-color/80 cursor-pointer transition-all w-1/2 bg-secondary-color border-2 border-white shadow-lg"
                    }
                  >
                    <div>Import</div>
                  </label>
            ...
            <div className={"flex p-5 flex-col gap-5 justify-center"}>
              ...
              >
                <p className={"text-center text-red-500 font-medium text-lg"}>
                  Your storage fulled! Please Delete some un-use files...{" "}
                  <br></br>{" "}
                  <span className={"text-lg text-green-600"}>Thank you! </span>{" "}
                </p>
              </ModalBody>
            </div>
          </ModalContent>
