    ...
    if (filenames === undefined) {
        return (
            <div className="flex flex-col justify-center items-center min-h-screen">
                ...
                <Button onClick={() => router.back()} color="primary" variant="bordered" className="mt-10">
        ...
        return (
            <div>
                <ToastContainer
                    ...
                    theme="light"
                />
                <p className="mt-10 mb-2 text-lg font-semibold text-primary-color">Select files to confirm</p>
                <div className="flex flex-col gap-3 w-full">
                    <CheckboxGroup label="Selecting files ..." value={selected} onValueChange={setSelected}>
                        {filenames?.map((item) => (
                            <div className={'flex flex-col gap-2 w-full overflow-y-scroll'} key={item}>
