...
const NonLinear = ({ data, headers }) => {
  ...
  return (
    <div className="overflow-x-scroll">
      <p className={"text-lg text-primary-color my-3 font-semibold"}>
        Descriptive table:{" "}
      </p>
      ...
      <p className={"text-lg my-3 text-primary-color font-semibold"}>
        Evaluation model:{" "}
      </p>
      <table className="w-full border">
        <tbody>
      ...
      <p className={"text-lg my-4 text-primary-color font-semibold"}>
        Descriptive Statistic:{" "}
      </p>
      <Descriptive_statistic
        data={data?.descriptive_statstics}
        headers={headers}
      />

      <p className={"text-lg my-4 text-primary-color"}>Coefficient Table: </p>
