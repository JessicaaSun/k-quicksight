...
const SimpleLinear = ({data}) => {
    ...
    return (
        <div className="overflow-x-scroll">
            <p className={'text-lg text-primary-color'}>Summary simple linear regression</p>
            ...
            <table className="w-full border">
                <tbody>
                    ...
                    <tr>
                        <td className="text-description-color border p-2">R_squared:</td>
            ...
            <div>
                <p className={'py-3 mt-5 text-primary-color text-lg'}>
