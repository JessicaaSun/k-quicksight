...
import {analysis_sample, mockData, sample_dataset} from "@/app/board/mockData/mockData";
    ...
    return (
        <div className={'px-5 py-5'}>
            <div className={'flex justify-between items-center'}>
                <p className={'text-primary-color font-medium text-2xl'}>Recent</p>
                <Input placeholder={'Search ...'} variant={"bordered"} color={'primary'} startContent={<SearchIcon />} className={'w-[384px]'} classNames={{
                    inputWrapper: [
                        'h-[42px] shadow-md'
                    ]
                }} />
