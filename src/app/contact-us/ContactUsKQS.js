...
const ContactUsKQS = () => {
  return (
    <main className="flex w-full flex-col lg:px-48 items-center justify-center lg:max-h-screen xl:pt-36 max-sm:pt-48 sm:pt-48 max-sm:pb-6 sm:pb-6 lg:pt-40 md:pt-40 md:px-14 max-sm:px-8 sm:px-8">
      <div className={" w-full md:gap-20 items-center md:flex "}>
        <div
          className={"flex w-full md:w-[90%] xl:w-[40%] lg:w-[80%] flex-col"}
        >
        ...
        <div
          className={"lg:w-1/2 md:w-[60%] flex items-center"}
          data-aos="zoom-in-up"
        >
          <Image
            src={contactus}
