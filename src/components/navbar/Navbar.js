              ...
              <NavbarBrand>
                <Link href="/" className="flex gap-5 justify-center items-center">
                  ...
                  <span className="text-primary-color font-semibold text-lg">
                    <img src="/essets/OnlineData (1).png" className="w-[216px]" />
                  </span>
                </Link>
              </NavbarBrand>
            </NavbarContent>
