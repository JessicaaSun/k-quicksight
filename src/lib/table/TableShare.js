...
export default function ShareTable({ file }) {
  ...
  return (
    <Table
      ...
      className={"rounded-xl shadow-sm border-1 border-gray-200"}
    >
      <TableHeader>
                ...
                {item.members ? (
                  ...
                  <Tooltip showArrow content={item.member.username}>
                    <Avatar
                      ...
                      src={
                        item.member.avatar
                          ? generateBashURL(item.member.avatar)
                          : "https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5?s=250"
                      }
                    />
                  </Tooltip>
            ...
            <TableCell>
              <Tooltip showArrow content={item.file.created_by.username}>
                <Avatar
                  ...
                  key={index}
                  src={
                    item.file.created_by.avatar
                      ? generateBashURL(item.file.created_by.avatar)
                      : "https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5?s=250"
                  }
                />
              </Tooltip>
